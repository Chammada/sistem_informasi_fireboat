...
@section('content')
    ...
    <div class="row">
        <div class="col-md-2 m-3">
            <a href="{{ route('create_berkas_page', ['id_jenis' => $page['id_jenis'], 'id_sub_jenis' => $page['id_sub_jenis']]) }}"
                                                    ...
                                                    <div class="input-group-prepend">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ route('edit_berkas_page', ['id_data' => $data->id]) }}"><i
                                                                    class="fas fa-edit"></i> Edit</a>
                                                            <a class="dropdown-item"
                                                                href="{{ route('download_file', ['id_data' => $data->id]) }}"><i
                                                                    class="fa fa-download" aria-hidden="true"></i>
                                                                Download</a>
                                                            <a class="dropdown-item"
                                                                href="{{ route('detail_data_berkas', ['id_data' => $data->id]) }}"><i
